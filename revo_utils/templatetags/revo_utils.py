...
@register.simple_tag
def render_bundle(bundle_name, extension=None, app=None, attrs=''):
    tags = utils.get_as_tags(bundle_name, extension=extension, app=app, attrs=attrs)
    return mark_safe('\n'.join(tags))
...
def get_files(bundle_name, extension=None, app=None):
    ...
    """
    return utils.get_files(bundle_name, extension=extension, app=app)
